...
-- Description:      test helper rtn for the sp_assert_not_null rtn being tested
-- Tested rtn desc:
...
--    @fn_     NVARCHAR(60),
--========================================================================================
CREATE PROCEDURE [test].[hlpr_048_sp_assert_not_null]
...
BEGIN
   DECLARE
      @fn                 NVARCHAR(35)   = N'hlpr_048_sp_assert_not_null'
...
---- RUN tested rtn:
   ...
   BEGIN
      BEGIN TRY
         ...
         EXEC  sp_assert_not_null @a,@msg,@msg2,@msg3,@msg4,@msg5,@msg6,@msg7,@msg8,@msg9,@msg10,@msg11,@msg12
