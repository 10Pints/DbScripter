...
-- Description:exports the test.TstDef table to file specified by @file_path param
-- Preconditions:
...
-- =======================================================================================
CREATE PROCEDURE [test].[sp_crt_mn_script_file]
   @file_path NVARCHAR(MAX)
AS
BEGIN
   SET NOCOUNT ON;
   DECLARE
       @fn           NVARCHAR(35)   = N'sp_crt_mn_script_file'
      ,@ret_code     INT
      ,@file_system  INT
