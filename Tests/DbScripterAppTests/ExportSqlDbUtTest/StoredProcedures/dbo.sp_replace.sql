...
END
/*
EXEC sp_replace('ab ,cde ,def, ghi,jk', ' ,', ',' );   
EXEC sp_replace('ab ,cde ,def, ghi,jk, lmnp', ', ', ',' );   
EXEC sp_replace('abcdefgh', 'def', 'xyz' );   -- abcxyzgh
EXEC sp_replace(null, 'cd', 'xyz' );          -- null
EXEC sp_replace('', 'cd', 'xyz' );            -- ''
EXEC sp_replace('as', '', 'xyz' );            -- 'as'
