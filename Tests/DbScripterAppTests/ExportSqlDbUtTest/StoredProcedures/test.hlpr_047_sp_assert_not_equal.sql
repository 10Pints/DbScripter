...
-- Description:      test helper rtn for the sp_assert_not_equal rtn being tested
-- Tested rtn desc:
...
--    @fn_     NVARCHAR(60),
--========================================================================================
CREATE PROCEDURE [test].[hlpr_047_sp_assert_not_equal]
...
BEGIN
   DECLARE
      @fn                 NVARCHAR(35)   = N'hlpr_047_sp_assert_not_equal'
...
---- RUN tested rtn:
   ...
   BEGIN
      BEGIN TRY
         ...
         EXEC  sp_assert_not_equal @a,@b,@msg,@msg2,@msg3,@msg4,@msg5,@msg6,@msg7,@msg8,@msg9,@msg10,@msg11,@msg12
